...
var Socket = function Socket(props) {
  var _useState = React.useState(Date.now() + 10000),
...
var parseMessage = function parseMessage(text) {
  ...
  words.map(function (word) {
    ...
    if (word.charAt(0) === '`') {
      ...
      codeAdded = true;
    } else if (word.charAt(word.length - 1) === '`' && sections[sections.length - 1].type['code']) {
...
var Body = function Body(props) {
  var sections = parseMessage(props.text);
  return /*#__PURE__*/React__default.createElement("div", {
    className: "ce-message-body"
